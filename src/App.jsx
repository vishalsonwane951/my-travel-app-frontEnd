...
const MyBookingsPage = lazy(() => import("./Pages/My Bookings/MyBookingsPage.jsx"));
const MyEnquiriesPage = lazy(() => import("./Pages/MyEnquiries/MyEnquiriesPage.jsx"));
...
import TravelLoaderBrandHorizontal from "./Components/Travelloader.jsx";
...
const App = () => {
  ...
  return (
    <>
      ...
      <PackageProvider>
        <AdminAuthProvider>
          <Suspense fallback={<div className="loading"><TravelLoaderBrandHorizontal /></div>}>
          <Routes>
            {/* Landing */}
